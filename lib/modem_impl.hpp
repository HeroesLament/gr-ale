...
#include <bitset>
#include <complex>
#include "../include/gnuradio/ale/modem.h"
    ...
    namespace ale {
        ...
        class Modem : public modem {
            ...
            private:
                ...
                int toneSamples;
                std::bitset<48> golayWord;
                std::bitset<24> codera;
                std::bitset<24> coderb;
            ...
            private:
                ...
                void encrypt();
                void decrypt();
                unsigned int interleave(unsigned int, unsigned int);
                std::tuple<unsigned int, unsigned int> deinterleave(unsigned int);
        };
    }
}
#endif // MODEM_HPP